package com.example.AdService.cli;

import com.example.AdService.AdServiceConfiguration;
...
public class RenderCommand extends ConfiguredCommand<AdServiceConfiguration> {
    ...
    @Override
    protected void run(Bootstrap<AdServiceConfiguration> bootstrap,
                       Namespace namespace,
                       AdServiceConfiguration configuration) throws Exception {
